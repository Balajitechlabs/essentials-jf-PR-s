...
fun DuoOtpOptionsBottomSheet(
    ...
    val isIslandEnabled = viewModel.isIslandEnabled.value
    ...
    EssentialsBottomSheet(
        ...
        Column(
            ...
            // Dynamic Island conflict warning
            if (isIslandEnabled) {
                RoundedCardContainer(
                    ...
                    IconToggleItem(
                        ...
                        title = stringResource(R.string.duo_otp_island_conflict_title),
                        description = stringResource(R.string.duo_otp_island_conflict_desc),
                        showToggle = false,
                    )
            ...
            // Sensitive notification permission card
            ...
            RoundedCardContainer(
                ...
                IconToggleItem(
                    iconRes = if (isSensitivePermissionGranted)
                        R.drawable.rounded_notifications_unread_24
                    else
                        R.drawable.rounded_notifications_paused_24,

                    title = stringResource(R.string.duo_otp_permission_title),
                    description = stringResource(
                        if (isSensitivePermissionGranted)
                            R.string.duo_otp_permission_granted_desc
                        else
                            R.string.duo_otp_permission_missing_desc
                    ),

                    showToggle = false,
                    onClick = if (isSensitivePermissionGranted) null else ({
